...
flags.DEFINE_string('net', 'alexnet.alexnet_v2', 'cnn architecture, e.g. vgg.vgg_a')
...
def main (_):
    (fold0_input, fold0_label, fold1_input, fold1_label, fold2_input, fold2_label, fold3_input, fold3_label, fold4_input, fold4_label)=GS_split_224_resize.GS_split_224_resize(sys.argv[1],size)
